...
struct RenderingResourceManager {
    ...
    MeshHandle CreateMesh(const BufferHandle vertexBuffer, const BufferHandle indexBuffer, VertexLayout&& layout,
    ...
    //todo: here well be more buffers such as structured buffers and also custom sampler, et.c.
